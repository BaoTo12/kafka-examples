...
public final class PipelinedReceiver extends AbstractReceiver {
    ...
    private final BlockingQueue<ReceivedEvent> receivedEvents;
    ...
    private void onPollCycle(WorkerThread t) throws InterruptedException {
        ...
        if (! records.isEmpty()) {
            for (var record : records) {
                ...
                final var event = new ReceivedEvent(value.getPayload(), value.getError(), record, value.getEncodedValue());
